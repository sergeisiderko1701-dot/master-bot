...
def support_intro() -> str:
    return (
        "🆘 <b>Підтримка</b>\n\n"
        "Напишіть ваше питання або проблему."
    )
...
def choose_category_text() -> str:
    return (
        ...
        "Ми покажемо заявку тільки відповідним майстрам.\n\n"
...
def tip_choose_master() -> str:
    return (
        ...
        "Зверніть увагу на рейтинг, час приїзду і ціну.\n"
...
def tip_after_choose_master() -> str:
    return (
        "💡 <b>Що далі?</b>\n\n"
        "Напишіть майстру або зателефонуйте, щоб домовитись про час і деталі."
    )
...
def tip_reopen_order() -> str:
    return (
        ...
        "Можна повторно відкрити заявку і обрати іншого майстра."
    )
...
def tip_master_offer() -> str:
    return (
        "💡 <b>Порада</b>\n\n"
        "Вкажіть реальну ціну, час приїзду і короткий коментар — так вас частіше обирають."
    )
...
def client_master_selected_text(
    ...
    rating_line = f"⭐ {_rating_text(rating)} ({reviews_count or 0})\n" if rating is not None else ""
    eta_line = f"⏱ {eta}\n" if eta else ""
...
def master_selected_for_master_text(order_id: int) -> str:
    return (
        ...
        "Зв'яжіться з клієнтом і домовтесь про деталі."
    )
...
def order_reopened_text(order_id: int) -> str:
    return (
        ...
        "Тепер можна обрати іншого майстра або дочекатись нових пропозицій."
    )
...
def no_offers_yet_text(order_id: int) -> str:
    return (
        ...
        "Ми розіслали її відповідним спеціалістам.\n\n"
