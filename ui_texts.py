...
def ask_district_text() -> str:
    return (
        "📍 <b>Оберіть район</b>\n\n"
        "Це допоможе показати заявку майстрам, які працюють у вашому районі."
    )


def ask_address_text() -> str:
    return (
        "🏠 <b>Вкажіть повну адресу</b>\n\n"
        "Напишіть вулицю і номер будинку.\n"
        "Наприклад: <b>вул. Академіка Корольова, 12</b>"
    )
